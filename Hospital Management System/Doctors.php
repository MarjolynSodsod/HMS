...
<div class="wrapper">
    ...
    <div class="main_content">
      ...
      <div class="info">
        ...
        <h2>Doctors</h2>
        <a class="add" href="doctor_add.php">Add</a>
        <br>

        <!--table to display the doctors data-->
        <table>
        <thead>
            <tr>
                <th>ID</th>
        ...
        <tbody>
          ...
          <?php
           ...
           //read the sql query to the doctor data
            ...
            while($row =$result->fetch_assoc()) {      
              ...
              <tr>
                ...
                <td class='Edit_view_btn'>
                  <a class='editbtn'href='doctor_edit.php?id=$row[id]'>Edit</a>
                  <a class='deletebtn' href='doc_del.php?id=$row[id]'>Delete</a>
                </td>
              </tr>";
            }
          ?>
