...
<div class="wrapper">
    ...
    <div class="main_content">
        ...
        <h2>Patients</h2>
        <a class="add" href="patient_add.php">Add</a>
        <br>

        <!--table to display the Patients data-->
        <table>
        <thead>
            <tr>
                <th>ID</th>
        ...
        <tbody>
            ...
            //read the sql query to the patient data
            ...
            while($row =$result->fetch_assoc()) {      
                ...
                <td class='Edit_view_btn'>
                   <a class='editbtn' href='patient_edit.php?id=$row[id]'>Edit</a>
                   <a class='deletebtn' href='patient_del.php?id=$row[id]'>Delete</a>
                </td>
            </tr>";
            }
