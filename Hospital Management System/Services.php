...
<div class="wrapper">
    ...
    <div class="main_content">
        ...
        <div class="Table_container">
           <h2>Service</h2>
           <a class="add" href="service_add.php">Add</a>
           <br>
           
           <!--table to display the Services data-->
            <table>
                <thead>
                <tr>
                <th>ID</th>
        ...
        <tbody>
           ...
           //read the sql query to the services data
            ...
            while($row =$result->fetch_assoc()) {      
                ...
                <td class='Edit_view_btn'>
                   <a class='editbtn' href='service_edit.php?id=$row[id]'>Edit</a>
                   <a class='deletebtn' href='service_del.php?id=$row[id]''>Delete</a>
                </td>
            </tr>";
            }
